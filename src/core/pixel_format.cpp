              ...
              std::size_t stride)
{
  ...
  } else if (Output == pixel_format::bgr888 || Output == pixel_format::rgb888) {
              ...
              bool flip_v)
{
  switch (to) {
    case pixel_format::bgr888:
      demosaic<BayerFormat, pixel_format::bgr888>(input_frame, width, height, output_frame, flip_v);
      break;
    case pixel_format::rgb888:
      demosaic<BayerFormat, pixel_format::rgb888>(input_frame, width, height, output_frame, flip_v);
      break;
    case pixel_format::bgra8888:
      demosaic<BayerFormat, pixel_format::bgra8888>(input_frame, width, height, output_frame, flip_v);
      break;
    case pixel_format::rgba8888:
      demosaic<BayerFormat, pixel_format::rgba8888>(input_frame, width, height, output_frame, flip_v);
      break;
                 ...
                 bool flip_v)
{
  switch (to) {
    case pixel_format::bgr888:
      return convert_rgb<Input, pixel_format::bgr888>(input_frame, width, height, output_frame, flip_v);
    case pixel_format::rgb888:
      return convert_rgb<Input, pixel_format::rgb888>(input_frame, width, height, output_frame, flip_v);
    case pixel_format::bgra8888:
      return convert_rgb<Input, pixel_format::bgra8888>(input_frame, width, height, output_frame, flip_v);
    case pixel_format::rgba8888:
      return convert_rgb<Input, pixel_format::rgba8888>(input_frame, width, height, output_frame, flip_v);
    case pixel_format::gray:
                   ...
                   bool flip_v)
{
  ...
  switch (from) {
    ...
    case pixel_format::bgr888:
      return convert_rgb<pixel_format::bgr888>(to, input_frame, output_frame, width, height, flip_v);
    case pixel_format::rgb888:
      return convert_rgb<pixel_format::rgb888>(to, input_frame, output_frame, width, height, flip_v);
    case pixel_format::bgra8888:
      return convert_rgb<pixel_format::bgra8888>(to, input_frame, output_frame, width, height, flip_v);
    case pixel_format::rgba8888:
      return convert_rgb<pixel_format::rgba8888>(to, input_frame, output_frame, width, height, flip_v);
    case pixel_format::yuyv:
